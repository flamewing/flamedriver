Snd_Boss2_Header:
	...
	smpsHeaderFM        Snd_Boss2_FM1,	$00, $11
	smpsHeaderFM        Snd_Boss2_FM2,	$0C, $0C
	smpsHeaderFM        Snd_Boss2_FM3,	$F4, $16
	smpsHeaderFM        Snd_Boss2_FM4,	$F4, $16
	smpsHeaderFM        Snd_Boss2_FM5,	$00, $1A
	smpsHeaderPSG       Snd_Boss2_PSG1,	$F4, $02, $00, $00
	smpsHeaderPSG       Snd_Boss2_PSG2,	$F4, $02, $00, $00
	smpsHeaderPSG       Snd_Boss2_PSG3,	$23, $02, $00, $00
...
Snd_Boss2_Loop13:
	...
	dc.b	nC6, $0F, nRst, $03
	smpsFMAlterVol      $09
	smpsLoop            $00, $05, Snd_Boss2_Loop13
	dc.b	nRst, $06
	smpsFMAlterVol      $D3
	smpsFMAlterVol      $06
	smpsModSet          $01, $01, $01, $06
	...
	smpsFMAlterVol      $FA
	smpsFMAlterVol      $04
	smpsLoop            $01, $02, Snd_Boss2_Jump01
...
Snd_Boss2_Loop14:
	...
	smpsFMAlterVol      $03
	smpsAlterPitch      $0C
	smpsLoop            $00, $02, Snd_Boss2_Loop14
	smpsFMAlterVol      $FC
	smpsAlterPitch      $F4
...
Snd_Boss2_Loop15:
	...
	smpsLoop            $00, $02, Snd_Boss2_Loop15
...
Snd_Boss2_Loop08:
	...
	smpsLoop            $00, $02, Snd_Boss2_Loop08

Snd_Boss2_Loop09:
	dc.b	nC4, $60, nEb4, nD4, nD4
	smpsLoop            $00, $02, Snd_Boss2_Loop09
...
Snd_Boss2_Loop0A:
	...
	smpsLoop            $00, $02, Snd_Boss2_Loop0A
	smpsJump            Snd_Boss2_Loop09
...
Snd_Boss2_Loop05:
	...
	smpsLoop            $00, $02, Snd_Boss2_Loop05

Snd_Boss2_Loop06:
	dc.b	nG3, $60, nA3, nA3, nG3
	smpsLoop            $00, $02, Snd_Boss2_Loop06
...
Snd_Boss2_Loop07:
	...
	smpsLoop            $00, $02, Snd_Boss2_Loop07
	smpsJump            Snd_Boss2_Loop06
...
Snd_Boss2_Loop1A:
	...
	dc.b	nC4, $60, nEb4, nD4, nD4
	smpsAlterPitch      $0C
	smpsLoop            $00, $02, Snd_Boss2_Loop1A
...
Snd_Boss2_Loop1B:
	...
	dc.b	nRst, $60
	smpsLoop            $00, $02, Snd_Boss2_Loop1B
	smpsAlterPitch      $F4
...
Snd_Boss2_Loop1C:
	...
	smpsPSGAlterVol     $FE
	smpsLoop            $00, $03, Snd_Boss2_Loop1C
	smpsPSGvoice        sTone_26
...
Snd_Boss2_Loop1D:
	...
	smpsLoop            $00, $02, Snd_Boss2_Loop1D
	smpsJump            Snd_Boss2_Loop1B
...
Snd_Boss2_Loop16:
	...
	dc.b	nG3, $60, nA3, nA3, nG3
	smpsAlterPitch      $0C
	smpsLoop            $00, $02, Snd_Boss2_Loop16
...
Snd_Boss2_Loop17:
	...
	dc.b	nRst, $4F
	smpsPSGAlterVol     $FD
	smpsLoop            $00, $02, Snd_Boss2_Loop17
	smpsAlterPitch      $F4
	smpsPSGvoice        sTone_1D
...
Snd_Boss2_Loop18:
	...
	dc.b	nEb4, nG3, nC4, nG3, nC3, nRst, $60
	smpsPSGAlterVol     $FE
	smpsLoop            $00, $03, Snd_Boss2_Loop18
	smpsPSGvoice        sTone_26
	smpsPSGAlterVol     $02
...
Snd_Boss2_Loop19:
	...
	smpsPSGAlterVol     $FE
	smpsLoop            $00, $02, Snd_Boss2_Loop19
	smpsJump            Snd_Boss2_Loop17
...
Snd_Boss2_Call00:
	...
	smpsLoop            $00, $04, Snd_Boss2_Call00
	smpsReturn
...
Snd_Boss2_Loop00:
	...
	dc.b	nRst, dSnareS3, nRst, nRst, nRst
	smpsLoop            $00, $06, Snd_Boss2_Loop00
	dc.b	dCrashCymbal, $06, nRst, nRst, nRst, dSnareS3, nRst, nRst, dKickS3, nRst, dKickS3, dKickS3
...
Snd_Boss2_Loop01:
	...
	dc.b	nRst, dSnareS3, nRst, nRst, nRst
	smpsLoop            $00, $08, Snd_Boss2_Loop01

Snd_Boss2_Loop02:
	dc.b	dKickS3, $18, dSnareS3, dKickS3, dSnareS3
	smpsLoop            $00, $0A, Snd_Boss2_Loop02
