Snd_VVZ2_Header:
	...
	smpsHeaderFM        Snd_VVZ2_FM1,	$00, $18
	smpsHeaderFM        Snd_VVZ2_FM2,	$0C, $0F
	smpsHeaderFM        Snd_VVZ2_FM3,	$F4, $10
	smpsHeaderFM        Snd_VVZ2_FM4,	$F4, $10
	smpsHeaderFM        Snd_VVZ2_FM5,	$00, $1C
	smpsHeaderPSG       Snd_VVZ2_PSG1,	$E8, $02, $00, $00
	smpsHeaderPSG       Snd_VVZ2_PSG2,	$E8, $04, $00, $00
	smpsHeaderPSG       Snd_VVZ2_PSG3,	$23, $02, $00, $00
...
Snd_VVZ2_Loop04:
	smpsCall            Snd_VVZ2_Call07
	smpsLoop            $00, $05, Snd_VVZ2_Loop04
	smpsCall            Snd_VVZ2_Call08
	smpsCall            Snd_VVZ2_Call09
	smpsCall            Snd_VVZ2_Call08
...
Snd_VVZ2_Loop05:
	...
	dc.b	$06, nF2, nF1, nF2
	smpsLoop            $00, $02, Snd_VVZ2_Loop05
	smpsJump            Snd_VVZ2_Loop04
...
Snd_VVZ2_Loop03:
	...
	dc.b	nC3
	smpsAlterPitch      $05
	smpsLoop            $00, $04, Snd_VVZ2_Loop03
	smpsAlterPitch      $F4
	smpsFMAlterVol      $03
	smpsSetvoice        $03
	smpsModSet          $01, $01, $02, $06
...
Snd_VVZ2_Loop02:
	...
	smpsAlterPitch      $05
	smpsModSet          $01, $01, $02, $06
	smpsLoop            $00, $04, Snd_VVZ2_Loop02
	smpsAlterPitch      $F4
	smpsFMAlterVol      $03
	smpsSetvoice        $03
	smpsModSet          $01, $01, $02, $06
...
Snd_VVZ2_Loop0B:
	...
	dc.b	nG4, $18, nC5, $3C
	smpsAlterPitch      $F4
	smpsLoop            $00, $02, Snd_VVZ2_Loop0B
	smpsAlterPitch      $0C
	smpsPSGvoice        sTone_26
	smpsModSet          $0F, $01, $01, $06
...
Snd_VVZ2_Loop09:
	smpsCall            Snd_VVZ2_Call0B
	smpsLoop            $00, $14, Snd_VVZ2_Loop09

Snd_VVZ2_Loop0A:
	smpsCall            Snd_VVZ2_Call0C
	smpsLoop            $00, $10, Snd_VVZ2_Loop0A
	smpsJump            Snd_VVZ2_Loop09
...
Snd_VVZ2_Loop00:
	...
	smpsCall            Snd_VVZ2_Call00
	smpsCall            Snd_VVZ2_Call02
	smpsLoop            $00, $05, Snd_VVZ2_Loop00

Snd_VVZ2_Loop01:
	smpsCall            Snd_VVZ2_Call03
	smpsCall            Snd_VVZ2_Call04
	smpsCall            Snd_VVZ2_Call03
	smpsCall            Snd_VVZ2_Call05
	smpsCall            Snd_VVZ2_Call03
	smpsCall            Snd_VVZ2_Call04
	smpsCall            Snd_VVZ2_Call06
